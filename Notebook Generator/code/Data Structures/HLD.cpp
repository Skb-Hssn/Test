/* 
subtree of v corresponds to segment [in[v], out[v]) and the path from v to the last vertex in ascending heavy path from v (which is nxt[v]) will be [in[nxt[v]], in[v]]
*/
const int N = 1e5 + 5;
const int LOGN = 18;
